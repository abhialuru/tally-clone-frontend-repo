...
function Navbar() {
  return (
    <nav className="w-full p-5 flex justify-between items-center">
      <div className="text-2xl font-bold text-black">tally*</div>
      <div className="flex gap-4 justify-center items-center font-semibold">
        ...
        <button className="px-2.5 text-sm text-white bg-[#0070d7] hover:bg-[#025db3] transition-all duration-100 ease-in cursor-pointer p-1 rounded-lg">
          Create form
        </button>
      </div>
    </nav>
